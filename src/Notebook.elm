...
import Http
import Identifiers exposing (notebookIdToString)
import Json.Encode as Encode exposing (Value)
import Json.Decode as Decode exposing (Decoder)
import Identifiers exposing (parseNotebookId)

endpoint : String
endpoint = "notebooks"

encodeNotebookId : NotebookId -> Value
encodeNotebookId notebookId = Encode.object
...
maybeToDecoder err maybeVal = case maybeVal of
    Just val -> Decode.succeed val
    Nothing -> Decode.fail err 
